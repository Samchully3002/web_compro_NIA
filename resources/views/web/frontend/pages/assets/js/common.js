$(document).ready(function () {
    ...
    $(".contact-wrapper form button").on("click", function () {
        ...
        if ($('.contact-wrapper form input[name="name"]').val() == "") {
            ...
            $('.contact-wrapper form textarea[name="content"]').val() == ""
        ) {
            if (url === "kr") {
            ...
            $('.contact-wrapper form input[type="checkbox"]').prop("checked") ==
            false
        ) {
            if (url === "kr") {
                ...
                $('.contact-wrapper form input[type="checkbox"]').focus();
                alert(
                    "Harap setujui pengumpulan dan penggunaan informasi pribadi."
                );
                return false;
            }
        }
