            ...
            <div class="product-wrapper">
                ...
                <div class="colls-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="card-wrapper">
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-A.svg"/>
                            ...
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-B.svg"/>
                        ...
                        <div class="card-wrapper">
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-C.svg"/>
                            ...
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-D.svg"/>
                        ...
                        <div class="card-wrapper">
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-E.svg"/>
                            ...
                            <div class="card">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher01-F.svg"/>
                ...
                <div class="colls-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="card-wrapper">
                            <div class="card-grey">
                                <img width="30%" src="../assets/images/icon/ic_exportvoucher03-A.svg"/>
                            ...
                            <div class="card-grey">
                                <img width="30%" src="../assets/images/icon/ic_exportvoucher03-B.svg"/>
                            ...
                            <div class="card-grey">
                                <img width="30%" src="../assets/images/icon/ic_exportvoucher03-C.svg"/>
                ...
                <div class="colls-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="card-wrapper">
                            <div class="card-grey">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher04-A.svg"/>
                            ...
                            <div class="card-grey">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher04-B.svg"/>
                        ...
                        <div class="card-wrapper">
                            <div class="card-grey">
                                <img width="18%" src="../assets/images/icon/ic_exportvoucher04-C.svg"/>
